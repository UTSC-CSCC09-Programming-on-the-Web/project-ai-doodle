        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="card p-6">
            <div class="flex items-center space-x-3 mb-6">
              ...
              <h2 class="text-xl font-semibold text-neutral-900">Creation Settings</h2>
            </div>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <p class="form-help">
                  DALL-E 3 provides higher quality images and better prompt understanding
                </p>
              </div>
              ...
              <div>
                ...
                <p class="form-help">
                  Describe your desired image in detail, including style, colors, composition, etc.
                </p>
              </div>
          ...
          <div class="card p-6">
            <div class="flex items-center justify-between mb-6">
              <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-neutral-900">Generation Result</h2>
              </div>
            ...
            <div v-if="isLoading" class="text-center py-16">
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  <p class="text-lg font-medium text-primary-600">AI is generating your image...</p>
                  <p class="text-sm text-neutral-500">This usually takes 10-30 seconds, please be patient</p>
                </div>
                <div class="max-w-md mx-auto bg-neutral-100 rounded-full h-2">
                  <div class="bg-gradient-to-r from-primary-500 to-accent-500 h-2 rounded-full animate-pulse" style="width: 60%"></div>
                </div>
              </div>
            </div>
            ...
            <div v-else-if="generatedImage" class="space-y-4">
              ...
              <div class="bg-neutral-50 rounded-xl p-4">
                <div class="grid sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span class="font-medium">{{ lastUsedModel.toUpperCase() }}</span>
                  </div>
                  <div v-if="imageInfo.usage">
                    <span class="text-neutral-600">Tokens Used:</span>
                    <span class="font-medium">{{ imageInfo.usage.total_tokens }} tokens</span>
                  </div>
                  <div>
              ...
              <div class="bg-primary-50 rounded-xl p-4">
                ...
                <p class="text-sm text-primary-700 italic">"{{ lastPrompt }}"</p>
              </div>
            </div>
            ...
            <div v-else class="text-center py-16">
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  <p class="text-lg text-neutral-500">Ready to create your first AI image</p>
                  <p class="text-sm text-neutral-400">Enter a description on the left and click the generate button</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="card p-6">
            <div class="flex items-center space-x-3 mb-4">
              ...
              <h3 class="text-lg font-semibold text-neutral-900">AI Assistant</h3>
            </div>
            
            <div class="space-y-4">
              <div class="bg-success-50 rounded-lg p-4">
                <p class="text-sm text-success-800">
                  <span class="font-medium">Current Model:</span> {{ selectedModel.toUpperCase() }}
                </p>
          ...
          <div class="card p-6">
            <div class="flex items-center space-x-3 mb-4">
              ...
              <h3 class="text-lg font-semibold text-neutral-900">Prompt Tips</h3>
            </div>
            
            <div class="space-y-3 text-sm">
              <div class="bg-warning-50 rounded-lg p-3">
                <h4 class="font-medium text-warning-800 mb-2">Quality Prompt Elements:</h4>
              ...
              <div class="space-y-2">
                ...
                <div class="bg-neutral-50 rounded-lg p-3">
                  <p class="text-xs text-neutral-600 italic">
                    "A fluffy orange kitten sitting under a cherry blossom tree, Japanese watercolor style, soft pink tones, warm sunlight filtering through petals"
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card p-6">
            <div class="flex items-center space-x-3 mb-4">
              ...
              <h3 class="text-lg font-semibold text-neutral-900">Usage Statistics</h3>
            </div>
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-between items-center">
                <span class="text-neutral-600 text-sm">Generated This Month</span>
