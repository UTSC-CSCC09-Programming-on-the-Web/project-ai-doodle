<template>
  <div class="page-container">
    <div
      class="content-container min-h-screen flex items-center justify-center p-4"
    >
      <div
      ...
      >
        <div class="flex min-h-[500px]">
          <!-- Left Side: Carousel -->
          <div
            class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary-500 to-accent-600"
          >
            <!-- Carousel Container -->
                ...
                >
                  ...
                  >
                    <div class="text-center text-white px-8 max-w-md">
                      <h2
                        class="text-4xl font-bold mb-4 leading-tight text-white"
                      >
                        {{ slide.keyword }}
                      </h2>
              ...
              <div class="p-6 lg:p-8 animate-fade-in">
                <div v-if="user" class="space-y-6">
                  ...
                  <div class="text-center space-y-4">
                    <div
                      class="w-20 h-20 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto"
                    >
                ...
                <div v-else class="text-center space-y-6">
                  ...
                  <div class="space-y-4">
                    ...
                    <h2
                      class="text-2xl lg:text-3xl font-semibold text-neutral-900"
                    >
                      Start Your AI Art Journey
                    </h2>
                    <p class="text-neutral-600 text-base lg:text-lg">
                      Login with your Google account to experience the AI
                  ...
                  <div
                    class="grid grid-cols-1 gap-4 mt-8 pt-6 border-t border-neutral-200"
                  >
                    <div class="flex items-center space-x-3">
                      ...
                      <span class="text-sm lg:text-base text-neutral-600"
                        >AI-powered image generation</span
                      >
                    </div>
                    <div class="flex items-center space-x-3">
                      <div
                      ...
                      <span class="text-sm lg:text-base text-neutral-600"
                        >Multiplayer collaborative game</span
                      >
                    </div>
                    <div class="flex items-center space-x-4">
                      ...
                      <span class="text-sm lg:text-base text-neutral-600"
                        >Fun word guessing challenge</span
                      >
                    </div>
                  </div>
                </div>
...
const carouselSlides = ref([
  {
    image:
      "https://images.unsplash.com/photo-1748164685063-bc408b0dc789?q=80&w=2274&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    keyword: "Creativity",
    description: "Bring ideas to life with your imagination and AI Doodle.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1729601713778-bb772d58f0f7?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    keyword: "Friendship",
    description: "Draw closer through doodles and guesses.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1666232784495-d865a7dc7de9?q=80&w=2656&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    keyword: "Brainstorm",
    description:
      "Chain your thoughts with words, and expand them through images.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1734549097883-fb428ab88cb2?q=80&w=1300&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    keyword: "Tension",
